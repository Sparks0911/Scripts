...
-- Global toggle states (persist on respawn)
local toggles = {
    fly = false,
    noclip = false,
    infJump = false,
...
local function enableAimbot()
    aimbotConnection = RunService.RenderStepped:Connect(function()
        ...
        if targetPlayer and targetPlayer.Character and targetPlayer.Character:FindFirstChild("Head") then
            ...
            -- Smoothly rotate camera towards target head
...
local function createGUI()
    ...
    -- Set current walk speed at startup
...
-- On respawn, recreate GUI and restore toggles
